package com.iresearch.android.http.ssl;
...
/**
 * @file EasySSLSocketFactory.java
 * @create 2014年7月10日 下午2:49:23
 * @author Jacky.Lee
 * @description This socket factory will create ssl socket that accepts self signed certificate
 */
