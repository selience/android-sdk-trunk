package com.iresearch.android.volley;
...
public class BitmapCache implements ImageLoader.ImageCache {
    ...
    private void init(int memCacheSize) {
        // Set up memory cache
        XLog.d(TAG, "Memory cache created (size = " + memCacheSize + "KB)");
    ...
    public void addBitmapToCache(String data, Bitmap bitmap) {
        ...
        synchronized (mMemoryCache) {
            ...
            if (mMemoryCache.get(data) == null) {
                XLog.d(TAG, "Memory cache put - " + data);
    ...
    public Bitmap getBitmapFromMemCache(String data) {
        if (data != null) {
            synchronized (mMemoryCache) {
                ...
                if (memBitmap != null) {
                    XLog.d(TAG, "Memory cache hit - " + data);
                    return memBitmap;
                }
            }
            XLog.d(TAG, "Memory cache miss - " + data);
        }
        return null;
    }
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            XLog.d(TAG, "Memory cache cleared");
        }
    }
