...
public class NativeResources {
    ...
    /**
     * Get a native boolean by name as in 'R.bool.name'. See
     * {@link android.content.res.Resources#getBoolean(int)
     * Resources.getBoolean()} for more info.
     */
    ...
    /**
     * Get a native integer by name as in 'R.integer.name'. See
     * {@link android.content.res.Resources#getInteger(int)
     * Resources.getInteger()} for more info.
     */
    ...
    /**
     * Get a native fraction by name as in 'R.fraction.name'. See
     * {@link android.content.res.Resources#getFraction(int)
     * Resources.getFraction()} for more info.
     */
    ...
    /**
     * Get a native drawable by name as in 'R.drawable.name'. See
     * {@link android.content.res.Resources#getString(int)
     * Resources.getString()} for more info.
     */
    ...
    /**
     * Get a native drawable by name as in 'R.drawable.name'. See
     * {@link android.content.res.Resources#getString(int, java.lang.Object...)
     * Resources.getString()} for more info.
     */
    ...
    /**
     * Get a native string by name as in 'R.string.name'. See
     * {@link android.content.res.Resources#getText(int) Resources.getText()}
     * for more info.
     */
    ...
    /**
     * Get a native string by name as in 'R.string.name'. See
     * {@link android.content.res.Resources#getText(int,java.lang.CharSequence)
     * Resources.getText()} for more info.
     */
     ...
     * Resources.getDrawable()} for more info.
     */
    ...
    /**
     * Get a native drawable by name as in 'R.drawable.name'. See
     * {@link android.content.res.Resources#getColor(int) Resources.getColor()}
     * for more info.
     */
    ...
    /**
     * Get a native drawable by name as in 'R.drawable.name'. See
     * {@link android.content.res.Resources#getColorStateList(int)
     * Resources.getColorStateList()} for more info.
     */
    ...
    /**
     * Get a native int array by name as in 'R.array.name'. See
     * {@link android.content.res.Resources#getIntArray(int)
     * Resources.getIntArray()} for more info.
     */
    ...
    /**
     * Get a native string array by name as in 'R.array.name'. See
     * {@link android.content.res.Resources#getStringArray(int)
     * Resources.getStringArray()} for more info.
     */
     ...
     * Resources.getTextArray()} for more info.
     */
    ...
    /**
     * Get a native typed array by name as in 'R.array.name'. See
     * {@link android.content.res.Resources#obtainTypedArray(int)
     * Resources.obtainTypedArray()} for more info.
     */
    ...
    /**
     * Get a native dimension by name as in 'R.dimen.name'. See
     * {@link android.content.res.Resources#getDimension(int)
     * Resources.getDimension()} for more info.
     */
     ...
     * Resources.getDimensionPixelOffset()} for more info.
     */
    ...
    /**
     * Get a native dimension by name as in 'R.dimen.name'. See
     * {@link android.content.res.Resources#getDimensionPixelSize(int)
     * Resources.getDimensionPixelSize()} for more info.
     */
    ...
    /**
     * Get a native plurals by name as in 'R.plurals.name'. See
     * {@link android.content.res.Resources#getQuantityString(int,int)
     * Resources.getQuantityString()} for more info.
     */
    ...
    /**
     * Get a native plurals by name as in 'R.plurals.name'. See
     * {@link android.content.res.Resources#getQuantityString(int,int,java.lang.Object...)
     * Resources.getQuantityString()} for more info.
     */
    ...
    /**
     * Get a native plurals by name as in 'R.plurals.name'. See
     * {@link android.content.res.Resources#getQuantityText(int,int)
     * Resources.getQuantityText()} for more info.
     */
    ...
    /**
     * Open a native raw resource by name as in 'R.raw.name'. See
     * {@link android.content.res.Resources#openRawResource(int)
     * Resources.openRawResource()} for more info.
     */
    ...
    /**
     * Open a native raw resource by name as in 'R.raw.name'. See
     * {@link android.content.res.Resources#openRawResource(int,android.util.TypedValue)
     * Resources.openRawResource()} for more info.
     */
    ...
    /**
     * Open a native raw resource by name as in 'R.raw.name'. See
     * {@link android.content.res.Resources#openRawResourceFd(int)
     * Resources.openRawResourceFd()} for more info.
     */
    ...
    /**
     * Get a native layout by name as in 'R.layout.name'. See
     * {@link android.content.res.Resources#getLayout(int)
     * Resources.getLayout()} for more info.
     */
    ...
    /**
     * Get a native integer by name as in 'R.xml.name'. See
     * {@link android.content.res.Resources#getXml(int) Resources.getXml()} for
     * more info.
     */
    ...
    /**
     * Get the index of an attribute within a stylable as in
     * 'R.styleable.styleable_attr'. In the practice this is pretty useless
     * since you can't access the actual styleable attribute.
     */
