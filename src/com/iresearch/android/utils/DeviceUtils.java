...
public class DeviceUtils {
    ...
    public static float pxToDp(Context ctx, float px) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, px, ctx.getResources()
                .getDisplayMetrics());
    }

    public static float dpToPx(Context ctx, float dp) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, ctx.getResources()
                .getDisplayMetrics());
    }
    ...
    public static String getAndroidId(Context context) {
        ...
        if (androidId == null) {
            androidId = ((TelephonyManager)context.getSystemService(Context.TELEPHONY_SERVICE))
                    .getDeviceId();
        }
        return androidId;
    }
