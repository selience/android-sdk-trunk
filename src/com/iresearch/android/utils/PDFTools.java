...
public class PDFTools {
    ...
    public static void downloadAndOpenPDF(final Context context, final String pdfUrl) {
        ...
        final ProgressDialog progress = ProgressDialog.show(context,"Please wait","Downloading PDF...", true);
    ...
    public static void askToOpenPDFThroughGoogleDrive(final Context context, final String pdfUrl) {
        new AlertDialog.Builder(context)
                .setTitle("Show PDF")
                .setMessage("You are trying to open a PDF file, but you don\'t have a PDF reader installed. Do you want to read the PDF file online with Google Drive (Requires Google account)?")
                .setNegativeButton("No", null)
                .setPositiveButton("Yes, read online",
                        new OnClickListener() {
                            @Override
    ...
    public static boolean isPDFSupported(Context context) {
        Intent i = new Intent(Intent.ACTION_VIEW);
        final File tempFile = new File(
                context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "test.pdf");
