 ...
 * @param <ReturnT>
 */
public abstract class AbstractAsyncTask<ContextT extends Context, ParameterT, ProgressT, ReturnT>
        extends AsyncTask<ParameterT, ProgressT, ReturnT> implements
        AsyncTaskHandler<ContextT, ProgressT, ReturnT>,
        AsyncTaskContextHandler<ProgressT, ReturnT> {

    public interface AsyncTaskCallable<ContextT extends Context, ParameterT, ProgressT, ReturnT> {
        public ReturnT call(AbstractAsyncTask<ContextT, ParameterT, ProgressT, ReturnT> task) throws Exception;
    }

    private volatile ContextT context;
    private AsyncTaskContextHandler<ProgressT, ReturnT> contextHandler;
    private AsyncTaskHandler<ContextT, ProgressT, ReturnT> delegateHandler;
    private AsyncTaskCallable<ContextT, ParameterT, ProgressT, ReturnT> callable;
     ...
     * implements {@link AsyncTaskContextHandler}, it will be registered to receive callbacks
     * itself. If instead it implements the more generic {@link AsyncTaskHandler}, <b>and if
     ...
     * as a {@link AsyncTaskHandler}, then the context will not receive callbacks via this
    ...
    public void connect(ContextT context) {
        ...
        if (context instanceof AsyncTaskContextHandler) {
            this.contextHandler = (AsyncTaskContextHandler<ProgressT, ReturnT>) context;
        } else if (delegateHandler == null && context instanceof AsyncTaskHandler) {
            this.delegateHandler = (AsyncTaskHandler<ContextT, ProgressT, ReturnT>) context;
        }
    ...
    /**
     * Connects an {@link AsyncTaskHandler} to this task to receive callbacks. The context
     * instance wrapped by this handler will be passed to {@link #connect(Context)}.
     * 
     * @param handler
     *            the handler object to receive task callbacks
     */
    public void connect(AsyncTaskHandler<ContextT, ProgressT, ReturnT> handler) {
    ...
    /**
     * If you have connected a Context which implements the {@link AsyncTaskContextHandler}
     * interface, this instance will be returned. Null otherwise.
     */
    public AsyncTaskContextHandler<ProgressT, ReturnT> getContextHandler() {
        return contextHandler;
    }

    /**
     * If you have connected a Context or POJO which implements the {@link AsyncTaskHandler}
     * interface, this instance will be returned. Null otherwise.
     */
    public AsyncTaskHandler<ContextT, ProgressT, ReturnT> getDelegateHandler() {
    ...
    public void setCallable(
            AsyncTaskCallable<ContextT, ParameterT, ProgressT, ReturnT> callable) {
