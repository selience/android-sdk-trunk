...
public abstract class EndlessListAdapter<T> extends BaseAdapter {
    ...
    public EndlessListAdapter(ListView listView, int progressItemLayoutResId) {
        this(listView.getContext(), listView, progressItemLayoutResId);
    }

    public EndlessListAdapter(ExpandableListView listView, int progressItemLayoutResId) {
        this(listView.getContext(), listView, progressItemLayoutResId);
    }

    public EndlessListAdapter(Context context, AbsListView listView, int progressItemLayoutResId) {
        this.progressView =LayoutInflater.from(context).inflate(progressItemLayoutResId, listView, false);
    }
